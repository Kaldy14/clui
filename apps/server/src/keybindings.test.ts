import { KeybindingCommand, KeybindingRule, KeybindingsConfig } from "@clui/contracts";
    ...
    Layer.provideMerge(
      Layer.effect(
        ...
        Effect.gen(function* () {
          ...
          const dir = yield* fs.makeTempDirectoryScoped({ prefix: "clui-server-config-test-" });
